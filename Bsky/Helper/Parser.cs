...
namespace Bsky.Net.Helper
{
    internal static partial class Parser
    {
        ...
        /// <summary>
        /// Tries to parse the given URI string and extracts its components.
        /// </summary>
        /// <param name="value">The URI string to parse.</param>
        /// <param name="uri">An array of strings containing the parsed components of the URI if parsing is successful; otherwise, an empty array.</param>
        /// <returns>
        /// <c>true</c> if the URI string is valid and parsing is successful; otherwise, <c>false</c>.
        /// </returns>
